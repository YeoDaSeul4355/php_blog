...
<body class="pink">
    ...
    <main id="main" class="container">
        <div class="login__inner">
            <h2>로그인</h2>
            <p>로그인을 하시면 게시글, 댓글 작성 및 보기가 가능합니다.<br>회원가입을 하면 로그인이 가능합니다.<br>admin@admin.com/1234</p>
            ...
            <div class="login__footer">
                <ul class="listStyle2">
                    ...
                    <li>아이디가 기억이 나지 않는다면? <a href="../login/idFind.php">아이디 찾기</a></li>
                    <li>비밀번호가 기억이 나지 않는다면? <a href="../login/passFind.php">비밀번호 찾기</a></li>
                </ul>
            </div>
        </div>
    </main>
